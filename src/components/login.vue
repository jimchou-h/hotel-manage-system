  ...
  <div class="bgImage">
    ...
    <div class="login-wrapper">
      ...
      <div class="login-body">
        <el-form :inline="true" :model="query" ref="query" :rules="rules">
          <el-form-item label="" prop="loginName" v-if="query.position != 'customer'">
            <el-input v-model="query.loginName" placeholder="请输入登录名"></el-input>
          </el-form-item>
          <el-form-item label="" prop="password" v-if="query.position != 'customer'">
            <el-input v-model="query.password" type="password" placeholder="请输入密码"></el-input>
          </el-form-item>
